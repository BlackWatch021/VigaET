        ...
        <div className="login_wrapper2">
            <div className="login_container2">
                <div className="img_contain2">
                    <img src="./data/img2.svg" alt="" />

                    <svg className='slider_svg2' width='290' height='166' viewBox="0 0 449 405" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="login_text">Customize your assessement and</span>
                <span className='login_text login_text2'> proctoring needs</span>
                <Link to='/intro3' className='link'><span className='login_button4'>{btn}</span></Link>
                <div className="slider_dots2">
                    <div className=""></div>
