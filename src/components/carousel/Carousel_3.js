...
const Login = () => {
    ...
    return (
        <div className="login_wrapper3">
            <div className="login_container3">
                <div className="img_contain3">
                    <img src="./data/img3.svg" alt="" />
                ...
                <span className="login_text3">Say no to false reports</span>
                <Link to='/intro4' className='link'><span className='login_button4'>{btn}</span></Link>
                <div className="slider_dots3">
                    <div className=""></div>
                    <div className=""></div>
